...
After an inbound call, cloudone-ai.com provides transcripts, analytics, and possible automation triggers.
...
- In your cloudone-ai.com dashboard, go to **Calls** or **History**.
