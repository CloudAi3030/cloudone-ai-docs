...
4. Click on external services and then check the option for SIP URI.
  ...
  Add ```sip:extension@5wed79aeavr.sip.livekit.cloud ``` (this is cloudone-ai.com SIP server address) .
...
## Step 2: Import numbers to cloudone-ai.com

You need to import to cloudone-ai.com.
