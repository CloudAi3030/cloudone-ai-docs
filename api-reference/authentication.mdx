...
The cloudone-ai.com API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your cloudone-ai.com account at [https://app.cloudone-ai.com](https://app.cloudone-ai.com)
...
```bash
curl -X GET "https://app.cloudone-ai.com/api/user/campaigns" \
